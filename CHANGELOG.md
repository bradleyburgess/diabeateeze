...
### Added
- `ALLOW_REGISTRATIONS` environment variable to enable or disable user sign-ups (defaults to `true`)
  - When set to `false`, allauth blocks access to the signup page and the "Sign up" link is hidden from the login page
0 Autofocus the glucose reading value in its form

## [1.1.3] - 2026-01-03

### Fixed
- Date bug in averages chart
- Colors for glucose stats
- Static collection in Dockerfile

## [1.1.2] - 2025-12-29

### Fixed
- Fixed broken test after changing default pagination size

## [1.1.1] - 2025-12-29

### Fixed
- Fixed table heading color

### Changed
- Refactored pagination into partial
